...
import br.com.fiap.api.usuarios_pettech.controller.exception.ControllerNotFoundExeption;
...
public class UsuarioService {
    ...
    public UsuarioDTO findById(Long id) {
        Usuario usuario = usuarioRepository.findById(id).orElseThrow(() -> new ControllerNotFoundExeption("Usuario não econtrado"));
    ...
    public UsuarioDTO update(Long id, UsuarioDTO usuarioDTO) {
        try {
            ...
            throw new ControllerNotFoundExeption("Usuário não econtrado");
        }
    }
